...
return array(
    ...
    'imgDomain' => 'http://www.autonissan.ru',
    'siteDomain' => 'http://www.autonissan.ru',
    //'pathToFiles' => '/var/www/gruber/export/img',
    'pathToFiles' => '/var/www/moscow_export/autonissan/export/img',
    ...
    'url'        => 'http://www.autonissan.ru/old_cars/',//страница с общим списком товаров
    ...
    'attributes' => array(
        'id'                            => array('selectors'=>array('div[class=breadcrumb] a[class=sel]'), 'required'=>true, 'modifier'=>array('md5'), 'type'=>'str'),
        'Наименование автомобиля'       => array('selectors'=>array('div[class=breadcrumb] a[class=sel]'), 'required'=>true, 'filters'=>array('strip_tags','trim'), 'type'=>'str'),
        'Цена'                          => array('selectors'=>array('span[class=price_value]'), 'required'=>true, 'filters'=>array('strip_tags','trim'), 'type'=>'str'), 
        'Комплектация'                  => array('selectors'=>array('div[class=tabs_detail] table ul li'), 'filters'=>array('trim'), 'type'=>'str'),
