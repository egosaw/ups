...
return array(
    ...
    'pathToFiles' => '/var/www/moscow_export/ascgroup/export/img',
    ...
    //'url'        => 'http://www.ascgroup.ru/pre_owned/?cl=n&b_filt=&PAGEN_1=16',//страница с общим списком товаров
    'url'        => 'http://www.ascgroup.ru/pre_owned/',//страница с общим списком товаров
    //'url'        => 'http://www.ascgroup.ru/pre_owned/?SHOWALL_1=1',//страница с общим списком товаров
    ...
    'attributes' => array(
        ...
        'Комплектация'                  => array('selectors'=>array('div[id=cont_tabs] div[class=tabs_sel] li'), 'filters'=>array('trim'), 'type'=>'str'),
        'Технические характеристики'    => array('selectors'=>array('td[class=detail_text_elem] div[class=identifier] table tr'), 'filters'=>array('strip_tags', 'trim'), 'type'=>'str', 'select'=>'innertext', 'replacer'=>array('<td class="value">', '^')),
        ...
        'Дополнительные изображения'    => array('selectors'=>array('div[class=pic_detail_car] a[class=small_pic]'), 'select'=>'onclick', 'type'=>'str', 'uploadFile'=>true, 'pregReplacer'=>array('%&big_img=(.*)&other_img%'))
    ),
